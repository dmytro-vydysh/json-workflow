...
export class JWDateCondition {
   ...
   */
  public static async is_before(context: JWContext,date: Date, compareTo: Date): Promise<boolean> {
   ...
   */
  public static async is_equal_or_before(context: JWContext,date: Date, compareTo: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
    JWChecker.isDate(compareTo, 2);
    return JWGetter.getDate(date).getTime() <= JWGetter.getDate(compareTo).getTime();
  }
   ...
   */
  public static async is_after(context: JWContext,date: Date, compareTo: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
    JWChecker.isDate(compareTo, 2);
    return JWGetter.getDate(date).getTime() > JWGetter.getDate(compareTo).getTime();
  }
   ...
   */
  public static async is_equal_or_after(context: JWContext,date: Date, compareTo: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
    JWChecker.isDate(compareTo, 2);
    return JWGetter.getDate(date).getTime() >= JWGetter.getDate(compareTo).getTime();
  }
   ...
   */
  public static async is_equal(context: JWContext,date: Date, compareTo: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
    JWChecker.isDate(compareTo, 2);
    return JWGetter.getDate(date).getTime() === JWGetter.getDate(compareTo).getTime();
  }
   ...
   */
  public static async is_today(context: JWContext,date: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
   ...
   */
  public static async is_past(context: JWContext,date: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
   ...
   */
  public static async is_future(context: JWContext,date: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
    return JWGetter.getDate(date).getTime() > Date.now();
  }
   ...
   */
  public static async is_weekend(context: JWContext,date: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
   ...
   */
  public static async is_weekday(context: JWContext,date: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
    const day = JWGetter.getDate(date).getDay();
    return day >= 1 && day <= 5;
  }
   ...
   */
  public static async is_between(context: JWContext,date: Date, start: Date, end: Date): Promise<boolean> {
    JWChecker.isDate(date, 1);
