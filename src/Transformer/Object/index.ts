...
export class JWObjectTransformer {
  ...
  public static async get_keys(obj: Record<string, any>): Promise<string[]> {
    JWChecker.isObject(obj, 1);
    return Object.keys(obj);
  }

  /** Returns all own enumerable values of the object. */
  public static async get_values(obj: Record<string, any>): Promise<any[]> {
    JWChecker.isObject(obj, 1);
    return Object.values(obj);
  }

  /** Returns a value by key and throws when the key is missing. */
  public static async get_key(obj: Record<string, any>, key: string): Promise<any> {
    JWChecker.isObject(obj, 1);
  ...
  public static async set_key(obj: Record<string, any>, key: string, value: any): Promise<Record<string, any>> {
    JWChecker.isObject(obj, 1);
    JWChecker.isString(key, 2);
  ...
  public static async join(obj1: Record<string, any>, obj2: Record<string, any>): Promise<Record<string, any>> {
